...
export default () => {
      ...
      return (
            ...
            <div className = {styles.pjdiv}>
                  ...
                  <ProjectCard {...shef}>
                  Shef is a recipe app aimed at busy students who can't find the time to make a Michelin star meal but also doesn't have the dough to order Doordash every day! Shef is a mobile app that encourages its users to make simple meals (typically &lt;3 ingredients (yes that is intentional and yes I just nested parentheses!)), share their simple recipes with others, and make posts related to anything food related that their hearts desire. This project won DTI's Internal Hackathon, by the way!! Built with Flutter and CSS.
                  </ProjectCard>
